					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								...
								<form style="display: block;" action="Register.php" method="POST">
									<div>
										<?php
									...
									<div class="form-group">
										<input type="password" name="confirmpassword" id="confirm-password" tabindex="3" class="form-control" placeholder="Confirm Password">
									</div>
									<div class="form-group">
										<div class="row">
